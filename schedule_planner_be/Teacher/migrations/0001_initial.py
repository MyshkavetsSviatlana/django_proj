    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fathers_name', models.CharField(blank=True, max_length=50, validators=[django.core.validators.RegexValidator(code='invalid_fathers_name', message="Write correct father's name", regex='^[А-яа-я-\\s]{1,50}$')], verbose_name="Father's name")),
                ...
                ('specialization', models.CharField(max_length=250, validators=[django.core.validators.RegexValidator(code='invalid_specialization', message='Write correct specialization', regex='^[А-яа-я-\\s]{1,250}$')], verbose_name='Specialization')),
